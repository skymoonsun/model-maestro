...
@router.api_route("/assistant/api/v1/chats", methods=["GET", "POST"], include_in_schema=True)
async def grafana_chats_handler(
    request: Request,
    ...
    """Grafana Assistant — List chats (GET) or create a new chat (POST)."""
    await _log_grafana_request(request)
